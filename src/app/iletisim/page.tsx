                ...
                <div className="container">
                    <div className="grid lg:grid-cols-2 gap-12">
                        ...
                        <div>
                            ...
                            <div className="space-y-6 mb-8">
                                <div className="flex items-start gap-4">
                                    ...
                                    <div>
                                        ...
                                        <div className="text-gray-600">Maltepe, İstanbul</div>
                                    </div>
                                </div>
                                <div className="flex items-start gap-4">
                                    <div className="w-12 h-12 flex items-center justify-center bg-[var(--primary)]/10 text-[var(--primary)] rounded-xl shrink-0">
                                    ...
                                    <div>
                                        ...
                                        <a href="tel:+905XXXXXXXXX" className="text-gray-600 hover:text-[var(--primary)]">0532 XXX XX XX</a>
                                    </div>
                                </div>
                                <div className="flex items-start gap-4">
                                    <div className="w-12 h-12 flex items-center justify-center bg-[var(--primary)]/10 text-[var(--primary)] rounded-xl shrink-0">
                            ...
                            <a href="https://wa.me/905XXXXXXXXX?text=Merhaba, bilgi almak istiyorum." target="_blank" rel="noopener noreferrer" className="btn-press flex items-center justify-center gap-2 w-full bg-[var(--accent)] hover:bg-[var(--accent-dark)] text-white py-4 rounded-xl font-semibold transition-colors">
                            ...
                            <div className="mt-8 rounded-2xl overflow-hidden h-64">
                                <iframe
                                    ...
                                    width="100%" height="100%" style={{ border: 0 }} allowFullScreen loading="lazy" title="Konum"
                                />
                            </div>
                        </div>
                    </div>
